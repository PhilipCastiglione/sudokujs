var rules = {
  ...
  // RULE 5
  updateXPossibilitiesInXCells: function() { // if x numbers exist in x cells
    this.updateXPossibilitiesUsing(indicesInRow); // for a given row
    this.updateXPossibilitiesUsing(indicesInCol); // cell
    this.updateXPossibilitiesUsing(indicesInQuadrant); // or quadrant
  },
  updateXPossibilitiesUsing(findIndicesFor) {
    for (var seg = 1; seg <= 9; seg++) {
